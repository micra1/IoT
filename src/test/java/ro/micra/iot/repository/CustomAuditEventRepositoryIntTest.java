package ro.micra.iot.repository;

import ro.micra.iot.IoTApp;
import ro.micra.iot.config.Constants;
import ro.micra.iot.config.audit.AuditEventConverter;
import ro.micra.iot.domain.PersistentAuditEvent;
...
import static ro.micra.iot.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
